...
<head>
    ...
    <style>
        ...
        /* 下部リンクエリア */
        .link-area { font-size: 14px; line-height: 2.2; }
...
<body>
    ...
    <div class="main-layout">
        ...
        <div class="content">
            ...
            <%-- 下部の遷移リンク --%>
            <div class="link-area">
                ・<a href="TestUpdate.action">続けて他の成績を変更する</a><br>
                ・<a href="${pageContext.request.contextPath}/auth/Menu.action">メニューへ戻る</a>
            </div>
        </div>
    </div>
